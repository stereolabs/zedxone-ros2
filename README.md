...
The ZED X One cameras are now officially supported by the [ZED ROS2 Wrapper](https://github.com/stereolabs/zed-ros2-wrapper) repository, utilizing the `stereolabs::ZedCameraOne` ROS 2component
